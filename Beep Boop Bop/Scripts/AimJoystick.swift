...
class AimJoystick: AnalogJoystick {
    ...
    init() {
        let substrateX = AnalogJoystickSubstrate(diameter: 100, color: .green, image: UIImage(named: "jSubstrate"))
        let stickX = AnalogJoystickStick(diameter: 20, color: .orange, image: UIImage(named: "jStick"))
